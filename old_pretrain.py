...
writer = SummaryWriter('tensorboard/'+MODEL_NAME)
hard_transform = torchvision.transforms.Compose([
    AugMix(),
...
# %%
model = BenchmarkModel([512, 512, 512], 'mini_resnet20')
model.to(device)
