...
python3 pretrain.py -t mae --model_name mae -b 128 -lr 0.0003 -ps 2 -o adamw -wd 0.05 -e 100 -w 15
python3 finetune.py --model_name mae -ptr 'model_checkpoints/model_pretrain_mae_[512, 512, 512]_bs=128_lr=0.0003_lambda=0.005.pt_masked' -ps 2 -tt finetune -b 128 -lr 0.0001 -e 50